...
REPORT_FILE_PATH = paths.rel2abs(__file__, "..", "resources")
...
class TestModels(ESTestCase):
    def setUp(self):
        ...
        print('*****************************************')
        print('STARTING TESTS in TEST REPORT')
        print("REPORT FILE = ", REPORT_FILE)
        print("RESOURCES = ", RESOURCES)
        print("MONTHTRACKER = ", MONTHTRACKER)
    ...
    def test_01_monthly_new(self):
        ...
        copyfile(REPORT_FILE, os.path.join(REPORT_FILE_PATH, 'report_test_01_monthly_new' + now.strftime("%Y%m%d%H%M%S") + '.csv'))
    ...
    def test_02_monthly_overlap_update(self):
        ...
        reports.delivery_report(from_date, to_date, REPORT_FILE)
        copyfile(REPORT_FILE, os.path.join(REPORT_FILE_PATH, 'report_test_02_monthly_overlap_update_1' + now.strftime("%Y%m%d%H%M%S") + '.csv'))
        ...
        reports.delivery_report(from_date, to_date, REPORT_FILE)
        copyfile(REPORT_FILE, os.path.join(REPORT_FILE_PATH, 'report_test_02_monthly_overlap_update_2' + now.strftime("%Y%m%d%H%M%S") + '.csv'))
    ...
    def test_03_multi_routed(self):
        print(">>>>>>>>>>>>>>>>> Entering test_03_multi_routed")
        notes1 = {
            "Uni A" : {
                1 : { "md" : 1, "content" : 2 },
                2 : { "md" : 3, "content" : 4 },
        ...
        # run the delivery report for the first time
        reports.delivery_report(from_date, to_date, REPORT_FILE)
        copyfile(REPORT_FILE, os.path.join(REPORT_FILE_PATH, 'report_test_03_multi_routed_1' + now.strftime("%Y%m%d%H%M%S") + '.csv'))
        ...
        # run the delivery report for the second and final time
        reports.delivery_report(from_date, to_date, REPORT_FILE)
        copyfile(REPORT_FILE, os.path.join(REPORT_FILE_PATH, 'report_test_03_multi_routed_2' + now.strftime("%Y%m%d%H%M%S") + '.csv'))
